...
<jsp:include page="./childer/all.jsp"></jsp:include>
	...
	<div class="main">
		...
		<div class="foot">
			...
			<a>订单状态:<%=states %></a></div>
		<div class="bottom">
			<a class="topfile" href="DeleteTakeOrder?orderId=<%=orderId%>" onclick="javascript:if(!confirm('确定删除吗?'))return false;">删除任务</a>
			<%if(state!=1){ %>
			<a class="topfile" href="editorTakeOrder.jsp?orderId=<%=orderId%>" >编辑任务</a>
			<%} %>
		</div>
	</div>
	</center>
